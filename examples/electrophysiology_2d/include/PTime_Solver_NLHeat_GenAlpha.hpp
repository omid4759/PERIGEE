#ifndef PTIME_SOLVER_NLHEAT_GENALPHA_HPP
#define PTIME_SOLVER_NLHEAT_GENALPHA_HPP
// ==================================================================
// PTime_Solver_NLHeat_GenAlpha.hpp
// 
...
class PTime_Solver_NLHeat_GenAlpha
{
  public:
    PTime_Solver_NLHeat_GenAlpha(const std::string &input_name, const int &input_record_freq,
        const int &input_renew_tang_freq, const double &input_final_time );

    ~PTime_Solver_NLHeat_GenAlpha();
