...
int main( int argc, char * argv[] )
{
  ...
  std::string geo_file("./mesh/coarse/mesh-complete/mesh-complete.mesh.vtu");
  std::string geo_base("./mesh/coarse/mesh-complete/mesh-surfaces/base.vtp");
  std::string geo_endo("./mesh/coarse/mesh-complete/mesh-surfaces/endo.vtp");
  std::string geo_epi ("./mesh/coarse/mesh-complete/mesh-surfaces/epi.vtp");
  int cpu_size = 1;
  int in_ncommon = 2;
